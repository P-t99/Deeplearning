###########################################################################
## Makefile generated for component 'nczallcode'. 
## 
## Makefile     : nczallcode.mk
## Generated on : Wed Oct 09 13:24:29 2024
...
COMPILER_COMMAND_FILE     = nczallcode_comp.rsp
CMD_FILE                  = nczallcode.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
DEFINES_STANDARD = -DMODEL=nczallcode -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\nczallcode_ert_rtw\nczallcode.c $(START_DIR)\nczallcode_ert_rtw\rtGetNaN.c $(START_DIR)\nczallcode_ert_rtw\rt_nonfinite.c

MAIN_SRC = $(START_DIR)\nczallcode_ert_rtw\ert_main.c
...
OBJS = nczallcode.obj rtGetNaN.obj rt_nonfinite.obj
...
{$(START_DIR)\nczallcode_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\nczallcode_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\nczallcode_ert_rtw}.cc.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\nczallcode_ert_rtw}.cxx.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
ert_main.obj : "$(START_DIR)\nczallcode_ert_rtw\ert_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\nczallcode_ert_rtw\ert_main.c"


nczallcode.obj : "$(START_DIR)\nczallcode_ert_rtw\nczallcode.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\nczallcode_ert_rtw\nczallcode.c"


rtGetNaN.obj : "$(START_DIR)\nczallcode_ert_rtw\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\nczallcode_ert_rtw\rtGetNaN.c"
